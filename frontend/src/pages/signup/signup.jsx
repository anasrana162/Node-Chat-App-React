        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              onChange={(i) => setInputs({ ...inputs, fullName: i.target.value })}
            />
          </div>
          <div>
            <label className='label p-2'>
            ...
            <input
              ...
              onChange={(i) => setInputs({ ...inputs, username: i.target.value })}
            />
          </div>
          <div>
            <label className='label p-2'>
            ...
            <input
              ...
              onChange={(i) => setInputs({ ...inputs, password: i.target.value })}
            />
          </div>
          <div>
            <label className='label p-2'>
            ...
            <input
              ...
              onChange={(i) => setInputs({ ...inputs, confirmPassword: i.target.value })}
            />
          </div>
